    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-[12px] p-6">
          <div className="mb-5">
            <h1 className="text-[18px] font-semibold text-white">Super Admin</h1>
            <p className="text-[13px] text-[#555] mt-1">Platform administration portal</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              ...
              <input
                ...
                placeholder="super@kyruadvisory.com"
                className={inputCls}
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-1 py-2.5 rounded-[8px] bg-[#3dbf8a] hover:bg-[#35a87a] disabled:opacity-60 text-white text-sm font-semibold transition-colors"
            >
